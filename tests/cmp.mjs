...
const DIR='/tmp/new/site', PORT=8951;
...
await p.screenshot({path:'/tmp/new/tests/compare.png',fullPage:true});
...
await p3.goto(`http://localhost:${PORT}/tools/compare.html?q=4501119831`);
...
const t0=Date.now();
await p2.goto(`http://localhost:${PORT}/tools/compare.html?q=4502539235`);
