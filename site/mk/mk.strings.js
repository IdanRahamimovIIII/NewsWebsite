...
window.PAGE_STR = {
  he: {
    ...
    bUndecided: "לא הוכרעו",        /* of an earlier Knesset, never got a verdict — the exact status is on each row */
