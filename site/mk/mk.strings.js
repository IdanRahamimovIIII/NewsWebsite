...
window.PAGE_STR = {
  he: {
    ...
    bStale: "לא הוכרעו",        /* of an earlier Knesset, never got a verdict — the exact status is on each row */
    ...
    tipStale: "הצעות מכנסות קודמות שלא הגיעו להכרעה. עם פיזור הכנסת הן פוקעות.",
  ...
  en: {
    ...
    tipStale: "Bills of earlier Knessets that never reached a verdict. They lapse when the Knesset dissolves.",
